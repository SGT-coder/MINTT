...
class ApiService {
  ...
  async assignCase(caseId: number, assignedTo: number, reason?: string): Promise<Case> {
  ...
  async updateCaseStatus(caseId: number, status: string, note?: string): Promise<Case> {
  ...
  async escalateCase(caseId: number): Promise<Case> {
